...
export function TDSleek2({children}) {
    return <div className='rules-toc-h2'>{children}</div>
}
export function TDSleek3({children}) {
    return <div className='rules-toc-h3'>{children}</div>
}