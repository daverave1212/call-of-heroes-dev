...
export const $SKILLS = [
    ...new Set(
        Object.values(SKILLS_BY_GROUP).flat()
    )
]
...
export const FLAWS_BY_GROUP = {
    ...
    'Nature': [
        ...
        'Attracts Animals',
        'Attracts Monsters',
        'Animals Distrust Him',
        'Maps Confuse Him',
        'Ropes Betray Him'
    ],

    'Magic': [
        'Magically Illiterate',
        'Arcane Illiterate',
        'Magically Clumsy',
        'Spell-Fumbler',
        'Magic-Blind',
        ...
        'Unnaturally Dramatic',
        'Unnaturally Serious',
        'Unnaturally Cheerful',
        'Unnaturally Gloomy',
        'Unnaturally Paranoid',
        'Unnaturally Trusting',
        'Can\'t Resist Magic',
        'Talks to Objects',
        'Talks to Animals',
        'Talks to the Dead',
        'Believes Coincidences Are Omens',
        'Distrusts Magic',
        'Trusts Magic Too Much',
        'Attracts Spirits',
        'Attracts Monsters',
        'Magic Distrusts Him',
        'Doors Hate Him',
    ...
    'Knowledge': [
        ...
        'Bad at Languages',
        'Bad at Research',
        'Bad at Investigation',
        'Bad at Remembering',
        'Bad at Problem Solving',
        'Bad at Recognizing Monsters',
        'Bad at Recognizing Magic',
        'Poor Reader',
        'Poor Writer',
        'Poor Vocabulary',
        'Mispronounces Words',
    ...
    'Dungeons': [
        ...
        'Can\'t Ignore a Mystery',
        'Can\'t Resist Treasure',
        'Directionally Cursed',
        'Doors Hate Him',
        'Locks Hate Him',
        'Maps Confuse Him',
    ...
    'Other': [
        ...
        'Laughs at Bad Times',
        'Forgets Why He Entered Rooms',
        'Attracts Trouble'
    ]
}
export const $FLAWS = [
    ...new Set(
        Object.values(FLAWS_BY_GROUP).flat()
    )
]
export const FLAW_GROUP_BY_ELEMENT = {
    'Fire': [
        'Physical',
        'Magic',
        'Dungeons',
