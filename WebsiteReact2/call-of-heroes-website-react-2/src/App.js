...
import V2Artificer from './databases/Core/Classes/Artificer.json'
...
import V2Knight from './databases/Core/Classes/Knight.json'
...
import V2Sorcerer from './databases/Core/Classes/Sorcerer.json'
import V2Soulwright from './databases/ClassesV2/Soulwright.json'
import V2Outlaw from './databases/Core/Classes/Swashbuckler.json'
