    ...
    <div className='home'>
      ...
      <div className="hero" id="Home-Advantages">
        ...
        <div className='advantages-content hero-content'>
          ...
          <p className='home-text-style'>Call of Heroes aims to be the one and only roleplaying game for this generation. Gather your party and embark on a campaign with properly designed rules, and, more importantly, exciting abilities and spells to <i>break</i> the rules!</p>
          <ul>
