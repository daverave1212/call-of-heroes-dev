...
const CHARACTER_SHEET_SRC = '/Download/Sheet-2025-10-10.png'
const WIDTH = 2480
...
const OTHER_TOP = 2530
const OTHER_GAP = 464
const INVENTORY_WIDTH = 1274
const MANA_LEFT = 1952
const MANA_TOP = 2582
const COORDINATES = {
    name: { x: WIDTH / 2, y: 164 },
    subname: { x: WIDTH / 2, y: 310 },
...
export async function printCharacterOnCanvas({ character: hero, canvas }) {
    ...
    // Big Numbers and names
    {
        ...
        drawText({ text: hero.names?.characterName, fontSize: 108, ...COORDINATES.name, ...options })
        drawText({
