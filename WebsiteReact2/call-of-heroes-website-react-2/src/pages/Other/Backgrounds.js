    ...
    return (
        <Page title="Backgrounds">
            ...
            <div className='with-margined-children'>
                ...
                <SmallStat color="var(--dark-green)" name="Languages" className="column">{cbg.Language}</SmallStat>
                <SmallStat color="var(--dark-green)" name="Training" className="column">{cbg.Training}</SmallStat>
            </div>
            ...
            { bgs.map(bg => (
                <div key={bg.Name}>
                    ...
                    <div className='with-margined-children'>
                        ...
                        { bg.Language != null && (
                            <SmallStat color="var(--dark-green)" name="Languages" className="column">{bg.Language}</SmallStat>
                        ) }
                        { bg.Training != null && (
                            <SmallStat color="var(--dark-green)" name="Training" className="column">{bg.Training}</SmallStat>
                        ) }
                        { bg.Abilities != null && (
