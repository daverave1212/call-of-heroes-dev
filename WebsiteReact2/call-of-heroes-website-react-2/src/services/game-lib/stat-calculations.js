...
export const MIGHT = 'Body'
export const DEXTERITY = 'Heart'
export const INTELLIGENCE = 'Mind'
export const SENSE = 'Spirit'
export const CHARISMA = 'Spirit'
...
export function calculateStatsToAttributesObject(statArray) {
    return {
        [MAX_HEALTH]: statArray[0] * 2,
        [HEALTH_REGEN]: statArray[3],
        [MOVEMENT_SPEED]: Math.ceil(statArray[1] / 2),
...
export const BONUS_ATTRIBUTES_CALCULATIONS_TEXTS_MAP = {
    ...
    [MOVEMENT_SPEED]: `50% of ${DEXTERITY} (rounded up)`,
